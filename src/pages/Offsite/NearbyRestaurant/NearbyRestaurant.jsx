    ...
    return (
        <>
            ...
            {/* <div className='mt-10'> */}
                ...
                >
                    {data?.restaurants && Array.isArray(data?.restaurants) && data?.restaurants?.map((story, _idx) => (<SwiperSlide className='mb-10 mt-10' key={_idx}><ViewStoryModal image={story?.res_id?.img} /></SwiperSlide>))}
                    
                    
                </Swiper> */}
            {/* </div> */}
            <div className='select-none'>
                <div className='mx-auto flex items-center scrollbar-hide overflow-x-auto justify-around w-[300px] md:w-[700px] lg:w-[900px] xl:w-[1200px] mt-8 mb-8 gap-5 lg:gap-0'>
                    {data?.stories && Array.isArray(data?.stories) && data?.stories?.map((story, _idx) => <ViewStoryModal key={_idx} image={story?.branchimg} imgList={story.Imgs}/>)}
                </div>
                            ...
                            <div className='border rounded-2xl shadow-md h-full'>
                                <Link to={`/restaurant/${restaurant?.res_id?._id}/branch/${restaurant?._id}`}>
                                    ...
                                    <div className='p-4 grid md:flex justify-between'>
                                        <p className='font-semibold capitalize'>{restaurant?.res_id?.res_name}- {restaurant?.branch_name}</p>
